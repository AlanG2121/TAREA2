...
public class ventana1 extends javax.swing.JFrame {
    ...
    String productos[]={"Pepsi","Cocacola","Galletas","Papaslays","Tortrix","Chicles","Chovix","CONDONES(EFECTO EXPLOSIVO)"};
    double precios[]={5.50,7.25,4,3,1,2,2.50,100};
    double precio =0;
    int cantidad=0;
    ...
    private void initComponents() {
        ...
        jLabel1.setText("TAREA 2 ALAN GALINDO 1190-22-11055");
        ...
        getContentPane().add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 270, 80, 30));
        ...
        getContentPane().add(btnAgregar, new org.netbeans.lib.awtextra.AbsoluteConstraints(790, 10, 130, 100));
        ...
        getContentPane().add(spnCantidad, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 220, 50, 30));
        ...
        getContentPane().add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 260, 90, 20));

        lblPrecio.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        lblPrecio.setText("Q 0.00 GTX");
        getContentPane().add(lblPrecio, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 270, 140, 20));

        lblTotal.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        lblTotal.setText("Q 0.00 GTX");
        getContentPane().add(lblTotal, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 260, 100, 20));
        ...
        getContentPane().add(lblImporte, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 220, -1, -1));
        ...
        getContentPane().add(btnActualizar, new org.netbeans.lib.awtextra.AbsoluteConstraints(560, 40, 110, 50));
